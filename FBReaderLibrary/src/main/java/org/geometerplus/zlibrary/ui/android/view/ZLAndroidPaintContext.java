...
public final class ZLAndroidPaintContext extends ZLPaintContext {
    ...
    public static ZLBooleanOption DeviceKerningOption = new ZLBooleanOption("Fonts",
        "DeviceKerning", false);
    public static ZLBooleanOption DitheringOption = new ZLBooleanOption("Fonts", "Dithering",
        false);
    ...
    public static final class Geometry {
        ...
        public Geometry(int screenWidth, int screenHeight, int width, int height, int leftMargin,
            int topMargin) {
