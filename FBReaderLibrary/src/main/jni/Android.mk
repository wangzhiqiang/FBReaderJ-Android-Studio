...
LOCAL_SRC_FILES               := LineBreak/LineBreaker.cpp LineBreak/liblinebreak-2.1/linebreak.c LineBreak/liblinebreak-2.1/linebreakdata.c LineBreak/liblinebreak-2.1/linebreakdef.c
...
LOCAL_MODULE                  := expat
LOCAL_SRC_FILES               := $(EXPAT_DIR)/lib/loadlibrary.c \
                                 $(EXPAT_DIR)/lib/xmlparse.c  \
                                 $(EXPAT_DIR)/lib/xmlrole.c \
                                 $(EXPAT_DIR)/lib/xmltok.c \
                                 $(EXPAT_DIR)/lib/xmltok_impl.c \
                                 $(EXPAT_DIR)/lib/xmltok_ns.c
